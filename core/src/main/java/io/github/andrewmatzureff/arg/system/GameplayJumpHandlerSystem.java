...
public class GameplayJumpHandlerSystem extends IteratingSystem {

    public GameplayJumpHandlerSystem() {
        super(Family.all(Jump.class, Move.class, Transform.class).get());
    }
...
//        final var moveDirection = move.getDirection();
